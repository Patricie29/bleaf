...
const Footer = () => {
    ...
    return (
        <>
            <footer className='relative w-[100%] min-h-[100px] pt-6 bg-[#5f8976] text-zinc-200'>
                <div className='flex flex-row justify-evenly items-center'>
                    <Image src={bLeafLogo} className='h-[90px] w-[100px] pb-3' alt='logo' />
                    ...
                    <ul className="flex justify-center items-center my-2 flex-wrap">
                        <div>
                            <li className="text-2xl mx-4 flex justify-center items-center gap-3 pb-3">
                                <BsTelephone />
                                <span className='text-sm'>0293939392</span>
                            </li>
                            <li className="text-2xl mx-4 flex justify-center items-center gap-3">
                                <SlLocationPin />
                                <span className='text-sm'>Queenstown</span>
                            </li>
                        </div>
