...
const Services = () => {
    return <>
        <div className="pt-[40px] md:pb-6 px-4 md:px-12" id="services">
            <div className="2xl:max-w-[1280px] w-full lg:w-[75%] mx-auto">

                {/* SERVICES */}
                <h1 className="text-center mb-11 md:mb-[80px] text-5xl md:text-7xl tracking-[2px]">Services</h1>
                ...
                <section className="flex flex-col md:flex-row py-8 px-4 relative">
                    <div className="w-full md:w-1/2 md:mt-16 mb-6 md:mb-0 pr-4">
